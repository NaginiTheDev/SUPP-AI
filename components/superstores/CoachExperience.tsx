...
// Hosts the marketing pitch + the Coach panel. When Coach starts working and
// then delivers, the left pitch column collapses away and the panel expands
...
function Pitch() {
  return (
    <div>
      <span className="inline-block rounded-full bg-red-500 px-3 py-1 text-xs font-black text-white">
        {BRAND.store}
      </span>
      <h1 className="mt-5 text-4xl font-black leading-[1.05] tracking-tight sm:text-6xl">
        Your personal
        <br />
        <span className="text-red-500">AI supplement coach.</span>
      </h1>
      ...
      <ul className="mt-6 space-y-2.5 text-sm text-zinc-300">
        {[
          ...
          <li key={t} className="flex items-center gap-2.5">
            <span className="flex h-5 w-5 items-center justify-center rounded-full bg-red-500 text-xs font-black text-white">
              ✓
            </span>
            {t}
          </li>
